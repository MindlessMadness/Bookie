...
class Auth with ChangeNotifier {
  ...
  Future<void> signUp(String email, String password) async {
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBmHmqaaQyrHuNn3_UjVsfaMOvUkuJLd6c');
    try {
  ...
  Future<void> logIn(String email, String password) async {
    final url = Uri.parse(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBmHmqaaQyrHuNn3_UjVsfaMOvUkuJLd6c');
    try {
      final response = await http.post(url,
          body: json.encode({
            'email': email,
